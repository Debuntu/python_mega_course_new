"""
in this part, we will try to enter user input in one line for example-
Type add, show, edit, complete or exit: add play chess
Type add, show, edit, complete or exit: edit 5
Type add, show, edit, complete or exit: complete 10
